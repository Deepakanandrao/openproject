...
RSpec.describe Settings::InputMethods, "#check_box_group", :aggregate_failures, :settings_reset, type: :forms do
  ...
  shared_examples "handling explicit :values param" do
    ...
    context "with an Array of Strings" do
      ...
      it "renders the checkboxes, using localized label text" do
        expect(rendered_form).to have_field count: 2, type: :checkbox, fieldset: "Ultimate answer"
        expect(rendered_form).to have_field "One", type: :checkbox
        expect(rendered_form).to have_field "Two", type: :checkbox
      end
    end
    ...
    context "with an Array of Arrays" do
      ...
      it "renders the checkboxes, using 'firsts' as label text" do
        expect(rendered_form).to have_field count: 2, type: :checkbox, fieldset: "Ultimate answer"
        expect(rendered_form).to have_field "Uno", type: :checkbox
        expect(rendered_form).to have_field "Duo", type: :checkbox
      end
    end
    ...
    context "with an Array of Arrays, including additional arguments Hash" do
      ...
      it "renders the checkboxes, using 'firsts' as label text and applying HTML attributes" do
        expect(rendered_form).to have_field count: 2, type: :checkbox, fieldset: "Ultimate answer"
        expect(rendered_form).to have_field "Uno", type: :checkbox do |field|
          expect(field["data-controller"]).to eq "numero-uno"
        end
        expect(rendered_form).to have_field "Duo", type: :checkbox do |field|
    ...
    context "with an Array of Hashes" do
      let(:values) do
        [
          { label: "Uno", value: "one", data: { controller: "numero-uno" } },
          { name: "two", value: "two", aria: { description: "NUMBER TWO" } }
        ]
      end

      include_examples "rendering fieldset"

      it "renders the checkboxes, using supplied label: or localized label and applying HTML attributes" do
        expect(rendered_form).to have_field count: 2, type: :checkbox, fieldset: "Ultimate answer"
        expect(rendered_form).to have_field "Uno", type: :checkbox do |field|
          expect(field["data-controller"]).to eq "numero-uno"
        end
        expect(rendered_form).to have_field "Two", type: :checkbox do |field|
          expect(field["aria-description"]).to eq "NUMBER TWO"
        end
      end
    end
  ...
  context "without :name param" do
    ...
    it "renders the checkbox, using specified :label" do
      expect(rendered_form).to have_field count: 1, type: :checkbox, fieldset: "Ultimate answer"
      expect(rendered_form).to have_field "Custom label", type: :checkbox
    end
  end
  ...
  context "with :name param and without a block argument" do
    ...
    context "when Setting has allowed values" do
      ...
      it "renders the checkboxes, using localized label text" do
        expect(rendered_form).to have_field count: 3, type: :checkbox, fieldset: "Ultimate answer"
        expect(rendered_form).to have_field "One", type: :checkbox
        expect(rendered_form).to have_field "Two", type: :checkbox
        expect(rendered_form).to have_field "Three", type: :checkbox
      end
