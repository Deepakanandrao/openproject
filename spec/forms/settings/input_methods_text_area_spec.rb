...
RSpec.describe Settings::InputMethods, "#text_area", :aggregate_failures, :settings_reset, type: :forms do
  ...
  it "renders the text area" do
    expect(rendered_form).to have_field "Ultimate answer", type: :textarea
  end
end
